    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Barlow', sans-serif; }
        ...
        .faq-question {
            ...
            color: var(--dark);
            cursor: pointer;
            list-style: none; /* Menyembunyikan segitiga bawaan */
            display: flex;
            justify-content: space-between;
            align-items: center;
            user-select: none;
        ...
        .faq-question::after {
            content: '\f078'; /* Ikon panah bawah FontAwesome */
        ...
        <div class="faq-container">
            ...
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Caranya sangat mudah. Silakan daftar/masuk ke akun Anda terlebih dahulu, lalu pilih menu <strong>Booking</strong> pada navigasi atas. Pilih jenis lapangan, tentukan tanggal serta jam bermain yang tersedia, lalu selesaikan pembayaran.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Tidak bisa. Untuk menjamin kepastian jadwal pemakaian lapangan bagi semua pengguna, seluruh pemesanan wajib diselesaikan secara online sebelum Anda datang ke lokasi lapangan.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Bisa. Permohonan jadwal ulang (reschedule) dapat dilakukan secara mandiri melalui profil akun Anda maksimal 24 jam sebelum jadwal bermain awal dimulai, bergantung ketersediaan slot kosong lapangan.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Ya. Setiap pemesanan 1 lapangan basket sudah mendapatkan fasilitas peminjaman 1 bola basket standar secara gratis selama durasi bermain Anda.</p>
                </div>
            </details>
            ...
            <details class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Demi menjaga permukaan dan keawetan lapangan, pengguna wajib mengenakan sepatu olahraga khusus (sepatu basket atau sepatu indoor non-marking) yang bersih dan tidak merusak permukaan kayu/vinyl.</p>
                </div>
            </details>
        </div>
    </div>
