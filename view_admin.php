...
/* ═══ WELCOME BANNER ═══ */
.welcome-banner { background: linear-gradient(135deg, #1F2937 0%, #111827 100%); border-radius: 20px; padding: 32px 36px; display: flex; align-items: center; justify-content: space-between; margin-bottom: 28px; overflow: hidden; position: relative; border: 1px solid #374151; }
.wb-deco { position: absolute; right: -30px; top: -30px; width: 200px; height: 200px; border-radius: 50%; background: radial-gradient(circle, rgba(255,69,0,.15) 0%, transparent 70%); }
.wb-deco2 { position: absolute; right: 80px; bottom: -40px; width: 140px; height: 140px; border-radius: 50%; background: radial-gradient(circle, rgba(255,69,0,.08) 0%, transparent 70%); }
...
.mini-stat-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-top: 16px; }
...
.data-table td { padding: 14px 20px; font-size: 13px; border-bottom: 1px solid var(--border-lt); vertical-align: middle; }
...
<<main class="main">
    ...
    <div class="content">
        ...
        <div class="alert-box">
            ...
            <span><?= $total_pending ?> booking menunggu konfirmasi Anda</span>
            <a href="booking.php?status=pending" style="color:#D97706; font-size:12px; font-weight:700; margin-left:auto; text-decoration:none;">Proses Sekarang →</a>
        </div>
        <?php endif; ?>
        ...
        <div class="welcome-banner">
            ...
            <div class="wb-text">
                <div class="wb-greeting">Selamat Bekerja</div>
                <div class="wb-name"><?= strtoupper(htmlspecialchars($nama)) ?> 👋</div>
                <div class="wb-sub">Kelola operasional harian HoopBall dengan efisien.</div>
            </div>
        ...
        <div class="stat-grid">
            <div class="stat-card sc-orange">
                <div class="stat-header">
                    <div class="stat-icon-wrap si-orange"><i class="fa-solid fa-calendar-day"></i></div>
                    <div class="stat-trend trend-up"><i class="fa-solid fa-arrow-up"></i> Hari Ini</div>
                </div>
                <div class="stat-value"><?= $total_booking_today ?></div>
                <div class="stat-label">Total Booking</div>
                <div class="stat-sublabel"><?= $total_confirmed ?> terkonfirmasi</div>
            </div>
            <div class="stat-card sc-yellow">
                <div class="stat-header">
                    <div class="stat-icon-wrap si-yellow"><i class="fa-solid fa-clock"></i></div>
                    <div class="stat-trend trend-warn"><i class="fa-solid fa-exclamation"></i> Perlu Aksi</div>
                </div>
                <div class="stat-value"><?= $total_pending ?></div>
                <div class="stat-label">Menunggu Konfirmasi</div>
                <div class="stat-sublabel">Segera proses booking</div>
            </div>
            <div class="stat-card sc-green">
                <div class="stat-header">
                    <div class="stat-icon-wrap si-green"><i class="fa-solid fa-money-bill-wave"></i></div>
                    <div class="stat-trend trend-up"><i class="fa-solid fa-arrow-up"></i> <?= rupiahFormat($pendapatan_hari) ?></div>
                </div>
                <div class="stat-value" style="font-size:24px;"><?= rupiahFormat($pendapatan_hari) ?></div>
                <div class="stat-label">Pendapatan Hari Ini</div>
                <div class="stat-sublabel"><?= $total_confirmed ?> booking confirmed</div>
            </div>
            <div class="stat-card sc-purple">
                <div class="stat-header">
                    <div class="stat-icon-wrap si-purple"><i class="fa-solid fa-layer-group"></i></div>
                    <div class="stat-trend trend-up"><i class="fa-solid fa-arrow-up"></i> <?= $lapangan_used ?>/<?= $total_lapangan ?></div>
                </div>
                <div class="stat-value"><?= $total_lapangan - $lapangan_used ?></div>
                <div class="stat-label">Lapangan Kosong</div>
                <div class="stat-sublabel"><?= $lapangan_used ?> sedang digunakan</div>
            </div>
        </div>
        ...
        <div class="chart-section">
            <div class="chart-card">
                <div class="chart-header">
                    <div class="chart-title"><i class="fa-solid fa-chart-pie"></i> Status Booking Hari Ini</div>
                </div>
                ...
                <div class="mini-stat-row">
                    <div class="mini-stat">
                        <div class="mini-stat-label">Terkonfirmasi</div>
                        <div class="mini-stat-value green"><?= $total_confirmed ?></div>
                    </div>
                    <div class="mini-stat">
                        <div class="mini-stat-label">Menunggu</div>
                        <div class="mini-stat-value orange"><?= $total_pending ?></div>
                    </div>
                    <div class="mini-stat">
                        <div class="mini-stat-label">Dibatalkan</div>
                        <div class="mini-stat-value red"><?= $total_cancelled ?></div>
                    </div>
                    <div class="mini-stat">
                        <div class="mini-stat-label">Customer</div>
                        <div class="mini-stat-value"><?= $total_customer ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><i class="fa-solid fa-hourglass-half"></i> Menunggu Konfirmasi</div>
                    <span class="card-badge"><?= count($waiting_bookings) ?> data</span>
                </div>
                <div class="card-body">
                    ...
                    <div class="waiting-item">
                        ...
                        <div class="waiting-info">
                            ...
                            <div class="waiting-detail">
                                <i class="fa-solid fa-location-dot"></i> <?= htmlspecialchars($w['Nama_Lapangan']) ?> • 
                                <i class="fa-regular fa-clock"></i> <?= formatJam($w['Jam_Mulai']) ?> - <?= formatJam($w['Jam_Selesai']) ?> • 
                                <?= rupiahFormat($w['Total_Harga']) ?>
                            </div>
                        </div>
                    ...
                    <div style="text-align:center; padding:30px; color:var(--muted);">
                        <i class="fa-solid fa-check-circle" style="font-size:32px; margin-bottom:10px; opacity:.5;"></i>
                        <div style="font-size:13px; font-weight:700;">Semua booking sudah terkonfirmasi!</div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><i class="fa-solid fa-list-check"></i> Booking Hari Ini</div>
                ...
                <div style="overflow-x:auto;">
                    <table class="data-table">
                        ...
                        <?php foreach($recent_bookings as $b): 
                            $status_map = [
                                'confirmed' => ['cls'=>'sp-confirmed','lbl'=>'Terkonfirmasi'], 
                                'pending' => ['cls'=>'sp-pending','lbl'=>'Menunggu'], 
                                'cancelled' => ['cls'=>'sp-cancelled','lbl'=>'Dibatalkan']
                            ];
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="cell-detail"><i class="fa-regular fa-clock"></i> <?= formatJam($b['Jam_Mulai']) ?> - <?= formatJam($b['Jam_Selesai']) ?></div>
                                </td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align:center; padding:30px; color:var(--muted);">
                                    ...
                                    <div style="font-size:13px; font-weight:700;">Belum ada data booking</div>
                                </td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
            ...
            <div style="display:flex; flex-direction:column; gap:20px;">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title"><i class="fa-solid fa-users"></i> Customer Terbaru</div>
                        <span class="card-badge"><?= count($recent_customers) ?> data</span>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="data-table">
                            ...
                            <?php foreach($recent_customers as $c): ?>
                                <tr>
                                    <td>
                                        <div class="cell-name"><?= htmlspecialchars($c['Nama_Customer']) ?></div>
                                        <div class="cell-detail"><?= htmlspecialchars($c['Email']) ?></div>
                                    </td>
                        ...
                        <div style="text-align:center; padding:20px; color:var(--muted);">
                            ...
                            <div style="font-size:12px; font-weight:700;">Belum ada data customer</div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    options: {
        ...
        plugins: {
            legend: {
                position: 'bottom',
                labels: { 
                    font: { family: 'Barlow', size: 12, weight: '700' }, 
                    color: '#6B7280', 
                    padding: 20, 
                    usePointStyle: true, 
                    pointStyle: 'circle' 
