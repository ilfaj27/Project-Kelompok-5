...
if (!$user_data) {
    ...
    error_log("[PROFILE PEMILIK ERROR] Data karyawan tidak ditemukan. " . $debug_info);
    echo '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8"><title>Error Profil</title>
...
if (isset($_POST['upload_photo']) && isset($_FILES['profile_photo'])) {
    ...
    if ($file['error'] === 0) {
        ...
        if (in_array($ext, $allowed)) {
            // Buat folder uploads/profiles di profile/ jika belum ada
    ...
    <div class="content">
        ...
        <div class="profile-grid">
            <div class="profile-card">
                ...
                <div class="profile-role"><?= strtoupper(htmlspecialchars($map_jabatan[$user_data['Jabatan']] ?? 'Manajer')) ?></div>
