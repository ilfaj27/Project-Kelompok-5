...
<nav class="navbar">
    ...
    <div class="nav-menu">
        ...
        <a href="<?= $prefix ?>customer/booking_customer.php"
            class="<?= isActive('booking_customer.php', 'customer') ? 'active' : '' ?>">Booking</a>
        <a href="<?= $prefix ?>customer/pembatalan_customer.php"
            class="<?= isActive('pembatalan_customer.php', 'customer') ? 'active' : '' ?>">Pembatalan</a>
        <a href="<?= $prefix ?>customer/langganan_customer.php"
            class="<?= isActive('langganan_customer.php', 'customer') ? 'active' : '' ?>">Member</a>
        <a href="<?= $prefix ?>customer/pembelian_alat.php"
            class="<?= isActive('pembelian_alat.php', 'customer') ? 'active' : '' ?>">Pembelian</a>
    </div>
    <div class="nav-btns">
            ...
            <div class="profile-dropdown-container">
                <button class="btn-profile-trigger" id="profileTrigger">
                    <?php if (!empty($nav_photo) && file_exists(navResolvePhoto($nav_photo))): ?>
                        <img src="<?= htmlspecialchars(navResolvePhoto($nav_photo)) ?>" alt="Avatar"
                            class="profile-icon-orange">
                    <?php else: ?>
                    ...
                    <?php if ($nav_has_member && !empty($nav_member_tipe)): ?>
                        <span class="member-badge-nav"><i class="fa-solid fa-crown"></i>
                            <?= htmlspecialchars($nav_member_tipe) ?></span>
                    <?php endif; ?>
                ...
                <div class="profile-dropdown-menu" id="profileDropdownMenu">
                    <div class="profile-dropdown-header">
                        ...
                        <span class="user-role">Customer
                            <?= $nav_has_member ? '• Member ' . htmlspecialchars($nav_member_tipe) : '' ?></span>
                    </div>
