<?php
// ============================================================
// KOP SURAT RESMI KHUSUS EXCEL (SISTEM LOCAL FILE PROTOCOL)
// ============================================================
...
<table cellpadding="2" cellspacing="0" style="width: 100%; border: none; text-align: center; font-family: Arial, Helvetica, sans-serif;">
    <tr>
        ...
        <td align="right" valign="middle" style="width: 18%; border: none !important; padding-bottom: 6px;">
            <img src="<?= $logo_real_path ?>" height="35" width="114" style="height: 38px; width: 114px; display: block;" alt="Logo" onerror="this.style.display='none'">
        </td>
        
        <!-- 3. Kolom Nama (Dimulai dari Kolom D ke kanan, rata kiri berdampingan rapat dengan logo) -->
        <td colspan="4" align="left" valign="middle" style="border: none !important; font-family: 'Times New Roman', Times, serif; font-size: 28px; font-weight: bold; letter-spacing: 2px; color: #000000; text-transform: uppercase; padding-left: 12px; padding-bottom: 6px;">
            HOOPBALL
        </td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: center; font-size: 10px; color: #111827; line-height: 1.5; font-weight: bold;">
    ...
    <tr>
        <td colspan="7" style="padding: 6px 0 0 0; border: none !important;">
    ...
    <tr>
        <td colspan="7" style="height: 12px; line-height: 12px; border: none !important; background-color: #FFFFFF;">&nbsp;</td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: center; font-family: 'Times New Roman', Times, serif; font-size: 15px; font-weight: bold; color: #000000; text-transform: uppercase; letter-spacing: 0.5px; border: none !important;">
            <?= htmlspecialchars($judul_tampil) ?>
        </td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: center; font-size: 9px; color: #374151; font-weight: bold; padding-top: 4px;">
