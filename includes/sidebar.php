...
<?php if (!defined('HB_SIDEBAR_ASSETS')): define('HB_SIDEBAR_ASSETS', true); ?>
<style>
/* ============================================================
   LOGO / BRAND — HoopBall
   ============================================================ */
...
.sb-brand::after { display: none !important; }


/* ============================================================
   SIDEBAR GROUP (DROPDOWN) — Master Data & Transaksi
   ============================================================ */
.sb-group { margin: 18px 0 4px; }
...
.sb-group-toggle {
    ...
    color: #6B7280; font-family: 'Barlow', sans-serif;
...
.sb-group-toggle::before {
    ...
    width: 0; height: 100%; border-radius: 10px; z-index: 0;
    background: linear-gradient(90deg, rgba(255,255,255,.07), rgba(255,255,255,.02));
    transition: width .35s cubic-bezier(.16,1,.3,1);
}
.sb-group-toggle:hover::before { width: 100%; }
.sb-group-toggle:hover { color: #E5E7EB; }
.sb-group-toggle > * { position: relative; z-index: 1; }
...
.sb-group-toggle:hover .sb-icon-wrap { background: rgba(255,255,255,.12); transform: scale(1.1); }

.sb-group-title { flex: 1; letter-spacing: .2px; }
...
.sb-group.open > .sb-group-toggle { color: #fff; background: rgba(255,69,0,.08); }
.sb-group.open > .sb-group-toggle .sb-icon-wrap {
    background: var(--orange); color: #fff;
    box-shadow: 0 4px 12px rgba(255,69,0,.3);
}
.sb-group.open > .sb-group-toggle .sb-group-chevron { transform: rotate(180deg); color: var(--orange); }
.sb-group.open > .sb-group-toggle .sb-group-count { background: rgba(255,69,0,.16); color: var(--orange); }

.sb-group:not(.open).has-active > .sb-group-toggle { color: #D1D5DB; }
.sb-group:not(.open).has-active > .sb-group-toggle .sb-icon-wrap { color: var(--orange); }
.sb-group:not(.open).has-active > .sb-group-toggle::after {
    content: ''; position: absolute; right: 32px; top: 50%;
    transform: translateY(-50%); z-index: 1;
    width: 6px; height: 6px; border-radius: 50%;
    background: var(--orange); box-shadow: 0 0 8px rgba(255,69,0,.7);
}
...
.sb-group-inner {
    position: relative;
    padding: 6px 0 2px 14px; margin-left: 15px;
    border-left: 1.5px solid rgba(255,255,255,.07);
}

.sb-group-inner .sb-link {
    opacity: 1 !important; animation: none !important;
    margin-bottom: 2px; padding: 9px 10px; font-size: 12.5px;
}
.sb-group-inner .sb-link .sb-icon-wrap { width: 28px; height: 28px; font-size: 11.5px; }

.sb-group-inner .sb-link.active::after {
    content: ''; position: absolute;
    left: -19px; right: auto; top: 50%; transform: translateY(-50%);
    width: 7px; height: 7px; border-radius: 50%;
    background: var(--orange); box-shadow: 0 0 8px rgba(255,69,0,.7);
}

.sb-group.open .sb-group-inner .sb-link { animation: sbSubIn .35s cubic-bezier(.16,1,.3,1) backwards !important; }
.sb-group.open .sb-group-inner .sb-link:nth-child(1) { animation-delay: .03s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(2) { animation-delay: .06s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(3) { animation-delay: .09s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(4) { animation-delay: .12s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(5) { animation-delay: .15s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(6) { animation-delay: .18s; }
.sb-group.open .sb-group-inner .sb-link:nth-child(7) { animation-delay: .21s; }
@keyframes sbSubIn { from { opacity: 0; transform: translateX(-10px); } to { opacity: 1; transform: translateX(0); } }
</style>
