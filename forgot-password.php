...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .btn-close-auth {
            position: absolute; top: 30px; left: 40px; width: 44px; height: 44px;
            ...
            justify-content: center; font-size: 18px; text-decoration: none; z-index: 100;
        ...
        .input-group label { font-size: 12px; font-weight: 700; color: var(--text-dark); margin-bottom: 8px; display: block; }
        ...
        .card-footer { margin-top: 24px; font-size: 12px; color: var(--text-muted); }
        ...
        .social-links a { width: 36px; height: 36px; background: #1E293B; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; text-decoration: none !important; border-bottom: none !important; transition: all 0.3s ease; }
        .social-links a:hover { background: var(--orange); text-decoration: none !important; border-bottom: none !important; }
...
<body>
    ...
    <div class="auth-hero-wrapper">
        <div class="auth-info" style="align-self: start; margin-top: 80px;">
            <h2>Atur Ulang<br><span>Kata Sandi Anda</span></h2>
            <p class="intro-p">Verifikasi identitas kepemilikan akun terdaftar Anda terlebih dahulu untuk membuat kata sandi baru.</p>
        </div>
            ...
            <div class="auth-card">
                ...
                <?php else: ?>
                    ...
                    <form method="POST" id="resetForm" novalidate>
                        ...
                        <button type="submit" name="reset_password" class="btn-submit" style="margin-top: 30px;">Reset Kata Sandi</button>
                    </form>
                <?php endif; ?>
            </div>
        </div>
