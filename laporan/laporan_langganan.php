        ...
        <div class="content">
            ...
            <form method="GET" class="filter-bar">
                ...
                <div class="filter-group">
                    ...
                    <select name="tipe">
                        ...
                        <?php foreach ($daftar_tipe as $t): ?>
                            <option value="<?= $t['ID_Tipe'] ?>" <?= $tipe_filter == $t['ID_Tipe'] ? 'selected' : '' ?>>
                                <?= htmlspecialchars($t['Nama_Tipe']) ?> (<?= rupiahFormat($t['Harga_Member']) ?>)</option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="filter-group">
                ...
                <div style="display: flex; gap: 6px; align-items: end; flex-wrap: wrap;">
                    ...
                    <!-- Tombol Reset -->
                    <a href="laporan_langganan.php" class="filter-btn secondary"
            ...
            <div class="stat-grid">
                <div class="stat-card sc-purple">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-purple"><i class="fa-solid fa-crown"></i></div>
                    </div>
                    <div class="stat-value"><?= $total_langganan ?></div>
                ...
                <div class="stat-card sc-blue">
                    ...
                    <div class="stat-value"><?= $total_berakhir ?></div>
            ...
            <div class="dashboard-grid" style="grid-template-columns: 2fr 1fr;">
                ...
                <div class="card" style="margin-bottom: 0;">
                    <div class="card-header">
                        <div class="card-title"><i class="fa-solid fa-chart-column"></i> Trend Langganan per Periode
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="chart-container"><canvas id="langgananChart"></canvas></div>
                    </div>
                </div>
                                ...
                                <?php foreach ($langganan_list as $lg):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="cell-detail"><?= rupiahFormat($lg['Harga_Member']) ?> | Potongan
                                                <?= rupiahFormat($lg['Potongan_Harga']) ?></div>
                                        </td>
                                        <td class="text-center">
                                            <div class="cell-name">
                                                <?= $lg['Tanggal_Mulai'] ? $lg['Tanggal_Mulai']->format('d M Y') : '-' ?> -
                                                <?= $lg['Tanggal_Selesai'] ? $lg['Tanggal_Selesai']->format('d M Y') : '-' ?>
                                            </div>
                                            <?php if ($expired): ?>
                                                <div class="cell-detail" style="color:var(--red);"><i
                                                        class="fa-solid fa-circle-exclamation"></i> Masa berlaku habis</div>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= htmlspecialchars($lg['Metode_Pembayaran']) ?></td>
                                        <td class="text-right">
                                            <div class="cell-price"><?= rupiahFormat($lg['Total_Bayar']) ?></div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" style="text-align:center; padding:40px; color:var(--muted);">
                                        ...
                                        <div style="font-size:14px; font-weight:700;">Tidak ada data langganan untuk filter
                                            yang dipilih</div>
                                    </td>
                                </tr>
                            <?php endif; ?>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                        <div
                            ...
                            <div
                                ...
                                <?= rupiahFormat($total_pendapatan) ?></div>
                        </div>
                        <div
...
function confirmDownload(type) {
    ...
    const text = isPdf 
        ? 'Laporan Langganan akan diunduh dalam format PDF. Lanjutkan?' 
        : 'Laporan Langganan akan diunduh dalam format Excel. Lanjutkan?';
    const confirmColor = isPdf ? '#EF4444' : '#10B981';
    const url = isPdf 
        ? 'cetak_pdf_langganan.php?<?= $_SERVER['QUERY_STRING'] ?>' 
        : 'cetak_excel_langganan.php?<?= $_SERVER['QUERY_STRING'] ?>';
