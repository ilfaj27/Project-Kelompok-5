...
$nama_file = 'LaporanPembelianAlat_' . $tanggal_unduh . '.xls';
...
<table border="1" cellspacing="0" cellpadding="6" style="width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 10px;">
    <thead>
        <tr style="background-color: #F3F4F6; font-weight: bold; text-align: center; vertical-align: middle;">
            ...
            <th style="width: 23%;">Item Dibeli</th>
...
if ($total_transaksi > 0) {
    ...
    foreach ($print_bookings as $b) {
        ...
        <tr>
            ...
            <td align="left" valign="center" style="width: 20%; vertical-align: middle;"><strong>' . htmlspecialchars($b['Nama_Customer']) . '</strong><br><span style="color: #6B7280; font-size: 9px;">' . htmlspecialchars($b['Email'] ?? '') . '</span></td>
            <td align="left" valign="center" style="width: 23%; vertical-align: middle;">' . $item_html . '</td>
            <td align="center" valign="center" style="width: 12%; vertical-align: middle;">' . $tanggal_beli . '</td>
            <td align="left" valign="center" style="width: 12%; vertical-align: middle;">' . htmlspecialchars($b['Metode_Pembayaran']) . '</td>
            <td align="center" valign="center" style="width: 13%; vertical-align: middle;"><span style="color: ' . $status_color . '; font-weight: bold;">' . $status_label . '</span></td>
