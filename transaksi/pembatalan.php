...
<body>
    ...
    <aside class="sidebar">
        <a href="../dashboard/view_admin.php" class="sb-brand">
            ...
            <div>
                ...
                <div class="sb-brand-sub">Sistem Manajemen</div>
            </div>
        </a>
        ...
        <div class="sb-bottom">
            <div class="sb-user">
                ...
                <a href="../login/logout.php" class="sb-logout" title="Keluar"><i
    ...
    <main class="main">
            ...
            <div class="topbar-right">
                ...
                <div class="dropdown-wrap">
                    ...
                    <div class="dropdown-menu">
                        <a href="../profile/profile.php" class="dd-item"><i class="fa-solid fa-id-badge"></i> Profil
                            Saya</a>
                        <hr class="dd-divider">
                        <a href="../login/logout.php" class="dd-item" style="color:var(--red);"><i
        ...
        <div class="content">
            ...
            <div class="stat-grid">
                <div class="stat-card sc-orange">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-orange"><i class="fa-solid fa-ban"></i></div>
                    </div>
                    <div class="stat-value"><?= $stats['total'] ?></div>
                    <div class="stat-label">Total Pembatalan</div>
                </div>
                <div class="stat-card sc-yellow">
                    ...
                    <div class="stat-label">Menunggu Refund</div>
                </div>
                <div class="stat-card sc-green">
                    ...
                    <div class="stat-label">Selesai Refund</div>
                </div>
                <div class="stat-card sc-blue">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-blue"><i class="fa-solid fa-money-bill-transfer"></i></div>
                    </div>
                    <div class="stat-value" style="font-size:18px;"><?= rupiahFormat($stats['total_refund']) ?></div>
                    <div class="stat-label">Dana Direfund</div>
                </div>
                <div class="stat-card sc-red">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-red"><i class="fa-solid fa-percentage"></i></div>
                    </div>
                    <div class="stat-value" style="font-size:18px;"><?= rupiahFormat($stats['total_denda']) ?></div>
            ...
            <!-- INFO BOX -->
            <div
                style="background: var(--orange-lt); border: 1px solid var(--orange); border-radius: 12px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
                <i class="fa-solid fa-circle-exclamation" style="color: var(--orange); font-size: 20px;"></i>
                <div style="font-size: 13px; color: var(--text); line-height: 1.5;">
                    <strong>Prosedur Refund 50%:</strong> Pembatalan sewa lapangan dikenakan denda pemotongan biaya
                    sebesar 50%.
                    Karyawan bertanggung jawab melakukan transfer balik sisa dana 50% (*Nominal Refund*) ke rekening
                    customer, lalu melakukan konfirmasi di bawah ini.
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span style="font-size: 12px; color: var(--muted); font-weight: 600;"><?= count($pembatalan_list) ?>
                        data ditemukan</span>
                </div>
                                ...
                                foreach ($pembatalan_list as $p):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="cell-detail"><?= formatTanggal($p['Tanggal']) ?>
                                                (<?= formatJam($p['Jam_Mulai']) ?> - <?= formatJam($p['Jam_Selesai']) ?>)</div>
                                        </td>
                                        <td><?= $tanggal_batal ?></td>
                                        <td style="font-weight: 800; color: var(--green);">
                                            <?= rupiahFormat($p['Nominal_Refund']) ?></td>
                                        <td><?= htmlspecialchars($p['Metode_Refund']) ?></td>
                                        <td><span class="status-pill <?= $status['class'] ?>"><i
                                                    class="fa-solid <?= $status['icon'] ?>"></i> <?= $status['label'] ?></span>
                                        </td>
                                        <td>
                                            <div class="action-btns">
                                                <!-- Cukup 1 Tombol Detail (Mata) -->
                                                <button class="btn-icon view" onclick="showDetail(<?= $p['ID_Pembatalan'] ?>)"
                                                    title="Detail"><i class="fa-solid fa-eye"></i></button>

                                                <?php if ($p['StatusRefund'] == 0): ?>
                                                    <!-- Cukup 1 Tombol Edit (Pensil) -->
                                                    <button class="btn-icon success"
                                                        onclick="editPembatalan(<?= $p['ID_Pembatalan'] ?>)" title="Edit Data"
                                                        style="border-color: var(--blue); color: var(--blue); background: var(--blue-lt);"><i
                                                            class="fa-solid fa-pen-to-square"></i></button>

                                                    <!-- Cukup 1 Tombol Konfirmasi Refund (Centang) -->
                                                    <button class="btn-icon success"
                                                        onclick="confirmRefund(<?= $p['ID_Pembatalan'] ?>, '<?= htmlspecialchars($p['Metode_Refund']) ?>', <?= $p['Nominal_Refund'] ?>)"
                                                        title="Konfirmasi Refund Selesai"><i class="fa-solid fa-check"></i></button>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" style="text-align: center; padding: 50px; color: var(--muted);">
                                        ...
                                        <div style="font-size: 12px; margin-top: 4px;">Belum ada transaksi sewa lapangan
                                            yang dibatalkan</div>
                                    </td>
                                </tr>
                            <?php endif; ?>
    ...
    <script>
        ...
        <div class="detail-grid">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">${data.Nama_Customer}</div>
                <div style="font-size: 11px; color: var(--muted); margin-top: 2px;">
                    ${data.Email} | ${data.No_Telepon}
                </div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Lapangan</div>
                <div class="detail-value">${data.Nama_Lapangan}</div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Jadwal Sewa Asli</div>
                <div class="detail-value">${tglJadwal}</div>
                <div style="font-size: 11px; color: var(--muted); margin-top: 2px;">
            ...
            <div class="detail-item">
                <div class="detail-label">Tanggal Pengajuan Batal</div>
                <div class="detail-value">${tglBatal}</div>
            </div>

            <div class="detail-item detail-full">
                <div class="detail-label">Alasan Pembatalan</div>
                <div class="detail-value" style="font-weight: 500; font-style: italic; line-height: 1.4;">
                    "${data.Alasan}"
                </div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Pembayaran Awal</div>
                <div class="detail-value">
                    ${formatRupiah(data.Total_Booking_Awal)} (${data.Metode_Bayar_Awal})
                </div>
            </div>

            <div class="detail-item">
                <div class="detail-label">Denda Pembatalan (50%)</div>
                <div class="detail-value price">
                    ${formatRupiah(data.Biaya_Batal)}
                </div>
            </div>

            <div class="detail-item detail-full" style="background:#ECFDF5; border: 1px solid #A7F3D0;">
                <div class="detail-label" style="color:#047857;">Dana Refund Dikembalikan (50%)</div>
                <div class="detail-value refund">
                    ${formatRupiah(data.Nominal_Refund)} (${data.Metode_Refund})
                </div>
            </div>
            ...
            <div class="detail-item detail-full">
                ...
                <div class="detail-value">
                    ${data.Nama_Karyawan_Proses || 'Belum Dikonfirmasi'}
                </div>
            </div>
        </div>
    `;
        ...
        function confirmRefund(id, metode, nominal) {
            Swal.fire({
                ...
                html: `Apakah Anda sudah mentransfer balik dana refund sebesar 
               <strong style="color:var(--green);">${formatRupiah(nominal)}</strong> 
               via <strong>${metode}</strong>?<br><br>
               <span style="color: var(--muted); font-size: 12px;">
                   Tindakan ini menyatakan bahwa hak refund customer telah ditransfer sepenuhnya.
               </span>`,
                icon: 'question',
