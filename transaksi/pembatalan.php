...
<div class="content">
    ...
    <div style="background: var(--orange-lt); border: 1px solid var(--orange); border-radius: 12px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
        ...
        <div style="font-size: 13px; color: var(--text); line-height: 1.5;">
            <strong>Prosedur Refund 50%:</strong> Pembatalan sewa lapangan dikenakan denda pemotongan biaya sebesar 50%. Karyawan bertanggung jawab melakukan transfer balik sisa dana 50% (*Nominal Refund*) ke rekening customer, lalu melakukan konfirmasi di bawah ini.
        </div>
    </div>
