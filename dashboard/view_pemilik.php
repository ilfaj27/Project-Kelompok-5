        ...
        <div class="content">
            <div class="welcome-banner">
                ...
                <div class="wb-text">
                    ...
                    <div class="wb-sub">Pantau performa bisnis dan kelola data sistem.</div>
                </div>
            ...
            <div class="stat-grid">
                <div class="stat-card sc-blue">
                    ...
                    <div class="stat-sublabel"><?= $total_karyawan_nonaktif ?> nonaktif</div>
                </div>
                <div class="stat-card sc-green">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-green"><i class="fa-solid fa-user-group"></i></div>
                        <div class="stat-trend trend-up"><i class="fa-solid fa-arrow-up"></i> Aktif</div>
                    </div>
                    <div class="stat-value"><?= $total_customer ?></div>
                    <div class="stat-label">Total Customer</div>
                    <div class="stat-sublabel"><?= $total_customer_aktif ?> aktif</div>
                </div>
                <div class="stat-card sc-orange">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-orange"><i class="fa-solid fa-boxes-stacked"></i></div>
                        <div class="stat-trend <?= $stok_rendah > 0 ? 'trend-warn' : 'trend-up' ?>"><i
                                class="fa-solid <?= $stok_rendah > 0 ? 'fa-triangle-exclamation' : 'fa-arrow-up' ?>"></i>
                            <?= $total_alat ?></div>
                    </div>
                    <div class="stat-value"><?= $total_alat ?></div>
                    <div class="stat-label">Total Alat</div>
                    <div class="stat-sublabel"><?= $total_alat_aktif ?> aktif | <?= $stok_rendah ?> stok rendah</div>
                </div>
                <div class="stat-card sc-purple">
                    <div class="stat-header">
                        <div class="stat-icon-wrap si-purple"><i class="fa-solid fa-money-bill-wave"></i></div>
                        <div class="stat-trend trend-up"><i class="fa-solid fa-arrow-up"></i> Total</div>
                    </div>
                    <div class="stat-value" style="font-size:24px;"><?= rupiahFormat($total_omzet) ?></div>
                    <div class="stat-label">Total Omzet</div>
                    <div class="stat-sublabel"><?= $total_booking_sukses ?> booking berhasil</div>
                </div>
            </div>
            ...
            <div class="dashboard-grid">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title"><i class="fa-solid fa-user-tie"></i> Karyawan Terbaru</div>
                        <div style="display:flex; align-items:center; gap:12px;"><span
                                class="card-badge"><?= count($recent_karyawan) ?> data</span><a
                                href="../master/karyawan.php" class="card-link">Kelola <i
                                    class="fa-solid fa-arrow-right" style="font-size:10px;"></i></a></div>
                    </div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if (count($recent_karyawan) > 0): ?>
                                    ...
                                    foreach ($recent_karyawan as $k):
                                        $status_cls = $k['Status'] == 1 ? 'sp-active' : 'sp-inactive';
                                        $status_lbl = $k['Status'] == 1 ? 'Aktif' : 'Nonaktif';
                                        ?>
                                        <tr>
                                            <td style="text-align: center; font-weight: 700; color: var(--muted);"><?= $no++ ?>
                                            </td>
                                            <td>
                                                <div class="cell-name"><?= htmlspecialchars($k['Nama_Karyawan']) ?></div>
                                            </td>
                                            <td><?= htmlspecialchars($map_jabatan[$k['Jabatan']] ?? $k['Jabatan']) ?></td>
                                            <td><?= htmlspecialchars($k['No_Telepon']) ?></td>
                                            <td style="text-align: center;">
                                                <span class="status-pill <?= $status_cls ?>"><?= $status_lbl ?></span>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" style="text-align:center; padding:30px; color:var(--muted);"><i
                                                class="fa-solid fa-inbox"
                                                style="font-size:32px; margin-bottom:10px; opacity:.5; display:block;"></i>
                                            <div style="font-size:13px; font-weight:700;">Belum ada data karyawan</div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                ...
                <div style="display:flex; flex-direction:column; gap:20px;">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="quick-grid">
                                <a href="../master/karyawan.php" class="quick-card" style="color:var(--green);"><i
                                        class="fa-solid fa-user-tie"></i><span>Kelola Karyawan</span></a>
                                <a href="../laporan/laporan_omzet.php" class="quick-card"
                                    style="color:var(--purple);"><i class="fa-solid fa-chart-line"></i><span>Laporan &
                                        Omzet</span></a>
                                <a href="../profile/profile_pemilik.php" class="quick-card"
                                    style="color:var(--blue); grid-column: span 2;"><i
                                        class="fa-solid fa-id-badge"></i><span>Profil Saya</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title"><i class="fa-solid fa-triangle-exclamation"></i> Alat Stok Rendah
                            </div><span class="card-badge"><?= count($alat_rendah) ?> item</span>
                        </div>
                        <div class="card-body">
                            <?php if (count($alat_rendah) > 0): ?>
                                <div style="display:flex; flex-direction:column; gap:10px; max-height: 240px; overflow-y: auto; padding-right: 4px;">
                                    <?php foreach ($alat_rendah as $a): ?>
                                        <div
                                            style="display:flex; align-items:center; justify-content:space-between; padding:10px; background:var(--red-lt); border-radius:8px; border:1px solid rgba(239,68,68,.15);">
                                            <div>
                            ...
                            <?php else: ?>
                                <div style="text-align:center; padding:20px; color:var(--muted);">
                                    <i class="fa-solid fa-check-circle"
                                        style="font-size:32px; color:var(--green); margin-bottom:8px; display:block;"></i>
