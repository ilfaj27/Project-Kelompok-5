    ...
    <style>
        ...
        * {
        ...
        .net::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(90deg, transparent 48%, rgba(255, 255, 255, 0.2) 49%, rgba(255, 255, 255, 0.2) 51%, transparent 52%), linear-gradient(60deg, transparent 48%, rgba(255, 255, 255, 0.15) 49%, rgba(255, 255, 255, 0.15) 51%, transparent 52%), linear-gradient(-60deg, transparent 48%, rgba(255, 255, 255, 0.15) 49%, rgba(255, 255, 255, 0.15) 51%, transparent 52%);
        ...
        @keyframes confettiExplode {
            ...
            100% {
                opacity: 0;
                transform: translate(calc(-50% + var(--cx)), calc(-50% + var(--cy))) scale(0) rotate(var(--cr));
            }
        }
        ...
        .exit-overlay.active .exit-loading-bar {
            animation: lbIn 0.5s ease-out 2.5s forwards;
        }
        ...
        .exit-overlay.active .exit-loading-fill {
            animation: lbFill 2s ease-out 2.5s forwards;
        }
        ...
        .exit-overlay.active .exit-vignette {
            animation: vigIn 1s ease-out 0.3s forwards;
        }
        ...
        body.exit-initiated {
            animation: bodyFade 0.6s ease-out forwards;
        }

        @keyframes bodyFade {
            to {
                filter: blur(10px) brightness(0.2) saturate(0);
