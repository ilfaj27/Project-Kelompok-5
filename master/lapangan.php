...
if (isset($_POST['save_lapangan'])) {
    $id = isset($_POST['id_lap']) ? $_POST['id_lap'] : null;
    ...
    $q_check_name = safe_sqlsrv_query($conn, $sql_check_name, array($nama_lapangan, $id ? $id : 0), false);
    ...
    if (isset($_POST['edit_mode']) && $id) {
        ...
        safe_sqlsrv_query($conn, "INSERT INTO Lapangan (Nama_Lapangan, Harga_Sewa, Status, Is_Deleted, Created_By, Created_Date) VALUES (?, ?, 1, 0, ?, GETDATE())", array($nama_lapangan, $harga, $nama), false);
...
.data-table th:nth-child(3), .data-table td:nth-child(3) { width: 22%; text-align: left !important; padding-left: 0 !important; position: relative; left: -0px !important; }
.lap-price { font-family: 'Barlow', sans-serif; font-weight: 700; font-size: 15px; color: var(--text); }

.data-table th:nth-child(4), .data-table td:nth-child(4) { width: 18%; text-align: center !important; padding-left: 0 !important; }
        ...
        <div class="modal-body">
            <form method="POST" id="formLapangan" onsubmit="return validateForm()" novalidate>
                <?php if ($edit_data): ?>
                    ...
                    <input type="hidden" name="id_lap" id="id_lap" value="<?= htmlspecialchars($edit_data['ID_Lapangan']) ?>">
                <?php endif; ?>
                        ...
                        <form method="GET" action="lapangan.php">
                            <div class="filter-group">
                                ...
                                <select name="f_sort" class="filter-input">
                                    <option value="id_asc" <?= ($_GET['f_sort'] ?? '') === 'id_asc' ? 'selected' : '' ?>>ID Lapangan &uarr;</option>
                                    <option value="id_desc" <?= ($_GET['f_sort'] ?? '') === 'id_desc' ? 'selected' : '' ?>>ID Lapangan &darr;</option>
