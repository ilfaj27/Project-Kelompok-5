...
function confirmDelete(id, name) {
    Swal.fire({
        title: 'Hapus Jadwal?',
        html: 'Anda akan menghapus jadwal lapangan <strong style="color:var(--orange);">' + name + '</strong><br><span style="font-size:12px;color:var(--muted);">Data akan dihapus secara soft-delete</span>',
        icon: 'warning',
        showCancelButton: true,
