...
// ============================================================================
$tipe_member_list = [];
$query_tipe = sqlsrv_query(
    $conn,
    "EXEC SP_TipeMember_GetActive"
);
if ($query_tipe) {
            ...
            if ($stmt_sp) {
                ...
                if ($result && $result['Status'] === 'SUCCESS') {
                    if (!empty($bukti_pembayaran_db) && !empty($result['ID_Langganan'])) {
                        sqlsrv_query(
                            $conn,
                            "EXEC SP_Langganan_UpdateBukti @ID_Langganan = ?, @Bukti_Pembayaran = ?",
                            array($result['ID_Langganan'], $bukti_pembayaran_db)
                        );
                    }

                    $stmt_tipe_name = sqlsrv_query(
                        $conn,
                        "EXEC SP_GetLanggananByID @ID_Langganan = ?",
                        array($result['ID_Langganan'])
                    );
                    $tipe_name = 'Member';
                    if ($stmt_tipe_name) {
    ...
    <style>
        ...
        * {
        ...
        @keyframes glowPulse {
            ...
            0%,
            100% {
                box-shadow: 0 0 20px rgba(255, 82, 0, 0.3)
            }

            50% {
                box-shadow: 0 0 40px rgba(255, 82, 0, 0.6)
            }
        }
        ...
        /* HERO */
        .hero {
            background: linear-gradient(135deg, #0B0B0C 0%, #1a1a2e 50%, #0d0d1a 100%);
        ...
        .member-detail-row:nth-child(2) {
            animation-delay: 0.7s
        }

        .member-detail-row:nth-child(3) {
            animation-delay: 0.8s
        }

        .member-detail-row:nth-child(4) {
            animation-delay: 0.9s
        }

        .member-detail-row:nth-child(5) {
            animation-delay: 1.0s
        }

        .member-detail-row:nth-child(6) {
        ...
        .member-detail-value.green {
            color: var(--green)
        }

        .member-detail-value.primary {
            color: var(--primary)
        }

        .member-detail-value.yellow {
            color: #D97706
        }
        ...
        .timeline-card:hover .timeline-type-icon {
            transform: scale(1.1) rotate(5deg);
        }
        ...
        .timeline-card:hover .timeline-status-badge {
            transform: scale(1.05);
        }
        ...
        .va-input-wrap:hover {
            border-color: var(--orange);
            box-shadow: 0 4px 16px rgba(255, 90, 31, .1)
        }
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-left">
            ...
            <p class="hero-desc">Dapatkan potongan harga khusus, prioritas jadwal, dan promo eksklusif dengan
                berlangganan member HoopBall.</p>
        </div>
        ...
        <div class="member-status-card">
            <div class="member-status-header">
                <div
                    class="member-status-icon <?php echo $has_member ? 'active' : ($member_pending ? 'pending' : 'inactive'); ?>">
                    <i
                        class="fa-solid <?php echo $has_member ? 'fa-crown' : ($member_pending ? 'fa-clock' : 'fa-user'); ?>"></i>
                </div>
            ...
            <?php if ($has_member): ?>
                ...
                <div class="member-detail-row">
                    ...
                    <span class="member-detail-value green"><?php echo rupiahFormat($member_aktif['Potongan_Harga']); ?>
                        /booking</span>
                </div>
                <div class="member-detail-row">
            ...
            <?php elseif ($member_pending): ?>
                <div class="member-detail-row">
                    <span class="member-detail-label">Tipe Member</span>
                    <span
                        class="member-detail-value primary"><?php echo htmlspecialchars($member_pending['Nama_Tipe']); ?></span>
                </div>
                <div class="member-detail-row">
    ...
    <main class="main-container">
        ...
        <section>
            <div class="section-header reveal">
                <div>
                    <h2 class="section-title"><i class="fa-solid fa-crown" style="color:var(--primary)"></i> Pilih Paket
                        Member</h2>
...
<div class="carousel-card-wrapper">
    ...
    <div class="pricing-scroll-wrapper" style="position: relative; overflow: hidden; margin-bottom: 60px;">
        ...
        <section class="riwayat-section">
            <div class="section-header reveal">
                <div>
                    <h2 class="section-title"><i class="fa-solid fa-clock-rotate-left" style="color:var(--primary)"></i>
                        Riwayat Langganan</h2>
                            ...
                            <div class="timeline-card" style="--card-accent: <?php echo $cfg['timeline_color']; ?>">
                                ...
                                <div class="timeline-card-header">
                                    <div class="timeline-card-title-area">
                                        <div class="timeline-type-icon"
                                            style="background: <?php echo $tipe_cfg['gradient']; ?>; color: <?php echo $tipe_cfg['text_color']; ?>;">
                                    ...
                                    <div class="timeline-status-badge"
                                        style="background: <?php echo $cfg['badge_bg']; ?>; color: <?php echo $cfg['badge_color']; ?>;">
                                        <i class="fa-solid <?php echo $cfg['icon']; ?>"></i>
                                ...
                                <?php if ($r['Status'] == 1): ?>
                                    <div class="timeline-progress-wrap">
                                        <div class="timeline-progress-label">
                                            ...
                                            <span style="color: <?php echo $cfg['timeline_color']; ?>"><?php echo $r_sisa_hari; ?>
                                                hari tersisa</span>
                                        </div>
                                        <div class="timeline-progress-bar">
                                            <div class="timeline-progress-fill"
                                                style="width: <?php echo $progress; ?>%; background: linear-gradient(90deg, <?php echo $cfg['timeline_color']; ?>, <?php echo $cfg['timeline_color']; ?>cc);">
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="timeline-details-grid">
                                    ...
                                    <div class="timeline-detail-item">
                                        ...
                                        <div class="timeline-detail-value">
                                            <?php echo htmlspecialchars($r['Metode_Pembayaran']); ?></div>
                                    </div>
                                    <div class="timeline-detail-item">
                                        <div class="timeline-detail-icon"
                                        ...
                                        <div class="timeline-detail-value">
                                            <?php echo rupiahFormat($r['Potongan_Harga']); ?>/booking</div>
                                    </div>
                                    <?php if ($r['Status'] == 1 && $r_sisa_hari > 0): ?>
                                        <div class="timeline-detail-item">
                                            ...
                                            <div class="timeline-detail-value" style="color: <?php echo $cfg['timeline_color']; ?>">
                                                <?php echo $r_sisa_hari; ?> hari</div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <?php else: ?>
                ...
                <div class="riwayat-empty">
                    ...
                    <a href="#pricingGrid" class="riwayat-empty-cta"
                        onclick="document.getElementById('pricingGrid').scrollIntoView({behavior:'smooth'});">
    ...
    <div class="booking-modal-overlay" id="checkoutModal">
        <div class="summary-card">
            <button class="booking-modal-close" onclick="tutupCheckoutModal()"><i
            ...
            <form method="POST" action="" id="formPembayaran" enctype="multipart/form-data">
                ...
                <div style="margin: 20px 0;">
                    <div class="payment-header" style="margin-bottom: 8px;">
                        <i class="fa-solid fa-receipt"></i> Unggah Bukti Pembayaran <span
                    ...
                    <input type="file" name="bukti_pembayaran" id="buktiPembayaranInput" accept=".jpg,.jpeg,.png,.pdf"
                        style="display:none" onchange="handleBuktiFileChange(this)">
