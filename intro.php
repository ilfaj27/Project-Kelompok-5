...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;800;900&family=Barlow:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --orange: #FF4500;
...
/* ════════════════════════════════════════
   ...
   ════════════════════════════════════════ */
        ...
        .float-particle:nth-child(7) {
            left: 90%;
            top: 45%;
            animation-delay: 2s;
        }

        .float-particle:nth-child(8) {
            left: 45%;
            top: 75%;
        ...
        <div class="ring-container">
            ...
            <div class="center-logo">
                <svg class="ball-svg" viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Highlight -->
                    <ellipse cx="48" cy="48" rx="22" ry="14" fill="rgba(255,255,255,0.12)"
                        transform="rotate(-30 48 48)" />
                    <!-- Inner shine -->
                    <ellipse cx="55" cy="42" rx="8" ry="5" fill="rgba(255,255,255,0.08)"
